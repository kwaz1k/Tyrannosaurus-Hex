...
function create() {
    ...
    const defaultPlayButtonImage = this.add.image(width / 2, height / 2 + 50, "defaultPlayButtonImage").setInteractive().on("pointerdown", startGame.bind(this)); // Вот здесь мы привязываем контекст
